namespace Bula.Fetcher.Controller.Pages {
    ...
    public class ViewItem : Bula.Meta {
        public static void Execute() {
            ...
            DataSet dsItems = doItem.GetById(INT(Request.Get("id")));
